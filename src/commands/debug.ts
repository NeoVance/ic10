import {CommandBuilder, Scope} from "./core";
import {Ic10Error} from "../Ic10Error";

export const makeDebugCommands: CommandBuilder = scope => {
    ...
    function setDevice(device: string, args: IArguments) {
    ...
    const dev = (device: string) => function () {
